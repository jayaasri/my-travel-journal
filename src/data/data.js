export default [
    ...
    },
    {
        ...
        a leisurely boat ride. The fresh eucalyptus scent from the nearby forests added 
        a calming touch to the entire experience. And don't even get me started on the 
        breathtaking sunrise at the Coaker's Walk!`
    },
    {
        id: 2,
        title: "Baijnath",
    ...
    },
    {
        ...
        cool climate was a welcome escape from the usual heat, and the views of misty 
        valleys were simply mesmerizing. The waterfalls and the calm backwaters were the 
        perfect spots for some quiet reflection.`
    },
    {
        id: 4,
        title: "Dubai",
        fromDate: "15, OCT 2010",
        ...
        it was a sensory overload in the best way possible! And let's not forget the 
        desert safari, where the endless dunes felt like an entirely different world. 
        Dubai is a place that surprises you at every corner.`
    },
    {
        id: 5,
        title: "Singapore",
        fromDate: "20, MAR 2013",
        ...
        out of a sci-fi movie, with their massive Supertrees and glowing domes. The food 
        scene here was just as diverse, offering everything from street food to 
   ...
   
    {
        ...
        The small, quiet town is perfect for those looking to escape the hustle and bustle of city life. 
    ...
    },
    {
        ...
        with the towering modern skyscrapers. A sunset cruise along the Corniche was the perfect way 
   ...
   
    {
        ...
        handicrafts. Jaipur is where history, culture, and architecture come together in the most beautiful way, 
        making every moment spent here feel like a journey through time.`
    },
    {
        id: 13,
        title: "Shimla",
        ...
        The cool, serene environment and the scenic beauty made Shimla the perfect escape from the summer heat, 
        offering peace and tranquility in abundance.`
    }
];
